    ...
    public partial class ListDetainedLicenses : GeneralForm
    {
       ...
       readonly ILicenseService _licenseService;
        ...
        private void LoadData()
        {
            ...
            _dtDetainedLicenses = _detainedLicenseServices.GetAll();
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            int PersonID = _applicationServices.GetByApplicationID(_licenseService.GetByID(LicenseID).ApplicationID).ApplicantPersonID;

            var frm = Program.Container.Resolve<ShowPersonLicenseHistory>(
            new ParameterOverride("PersonID", PersonID));
            frm.ShowDialog();
